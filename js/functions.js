$(function(){
    ...
    $('.barra-preco').mousemove(function(e){
        if(isDrag == true){
            ...
            curVal = (mouseX / elBase.width()) * 100;
            $('.barra-preco-fill').css('width',curVal+'%');

            preco_atual = (curVal/100) * preco_maximo;
    ...
    function clickSlider(){
        $('.mini-img-wraper').on('click',function(){
            $('.mini-img-wraper').removeClass('mini-img-sel');
            $(this).addClass('mini-img-sel');
    ...
    //Clicar Contato
    $('[goto=contato]').on('click',function(){
